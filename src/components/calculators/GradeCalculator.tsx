...
export function GradeCalculator() {
  ...
  return (
    <CalculatorShell
      ...
      results={
        <div className="space-y-4">
          <ResultCard label="Overall Score" value={`${finalGrade.toFixed(1)}%`} color="indigo" />
          ...
          <div className="pt-2">
            ...
            {totalWeight !== 100 && (
              <div className="mt-2 text-[10px] text-amber-700 bg-amber-50 p-2.5 rounded-lg border border-amber-100 leading-normal">
                Weights sum to <strong>{totalWeight}%</strong> instead of 100%. We have automatically scaled your grades proportionally.
              </div>
            )}
          </div>
        </div>
