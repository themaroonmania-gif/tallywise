...
try {
  ...
  if (fs.existsSync(wranglerBinPath)) {
    console.log('Wrapping wrangler to compile opennext synchronously before CLI execution...');
...
`;
    ...
    console.log('Wrangler wrapped successfully with dynamic compilation and pass-through execution!');
  } else {
